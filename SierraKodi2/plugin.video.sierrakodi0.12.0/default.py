...
base='http://spartanpixel.net'
ADDON=xbmcaddon.Addon(id='plugin.video.sierrakodi')
...
def CATEGORIES():
    link = OPEN_URL('https://github.com/Sierrakodi/SierraKodi/blob/master/SierraKodi/wizard_test.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dialog.ok("DOWNLOAD COMPLETE YAY :)", 'To ensure all changes are saved you must now close Kodi', 'Unplug your device from the Tv or Outlet and Restart.')
    killxbmc()
